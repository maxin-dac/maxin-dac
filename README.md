...
### Data Analyst & Business Intelligence Analyst — Yaoundé, Cameroon 🇨🇲
...
My cross-disciplinary background — **Public Law × Computer Science × Economic Intelligence** (Master's degree, High Honors) — lets me approach data problems from both a strategic and an operational angle.

Beyond Data & BI, I enjoy exploring new technologies, particularly anything related to **applied AI** (agents, Copilot, automation) — a technical curiosity I keep documenting through my Microsoft certifications and Applied Skills.

- 🔭 Currently working on: a Power BI dashboard on World Bank development indicators (211 countries, 1990–2021)
- 🌱 Currently learning: Microsoft Fabric (Data Warehouse & Real-Time Intelligence), AI agents applied to data workflows
- 🤝 Volunteer work: Communications Manager — *Café Citoyen 237* (civic dialogue association, Yaoundé)
- 📫 Reach me: **ndacleumaxime@gmail.com**
...
> 📌 *Both projects are being finalized and will be published as dedicated repositories on this profile.*
