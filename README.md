...
![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&size=20&pause=1000&color=0E2841&center=true&vCenter=true&width=650&lines=Turning+raw+data+into+decisions;Python+%C2%B7+SQL+%C2%B7+Power+BI+%C2%B7+Microsoft+Fabric;Dashboards+%C2%B7+AI+agents+%C2%B7+automated+workflows)
...
Data Analyst & Business Intelligence Analyst with experience leading **multi-country market studies** across the banking, energy, and services sectors. I cover the full analytical cycle — data collection and processing, modeling, and delivery of reports with **decision-oriented recommendations**.
...
Beyond Data & BI, I explore applied AI — agents, Copilot, automation — a technical curiosity I keep documenting through my Microsoft certifications, Applied Skills, and hands-on projects.
...
![World Bank API](https://img.shields.io/badge/World%20Bank%20API-0072BC?style=flat)

An interactive, **bilingual (EN/FR)** platform analyzing **217 countries** across **25 years (2000–2024)** through **58 World Bank indicators**, structured around the **PESTEL** framework. Seven coordinated views — world map, trends & correlations, country profiles, comparison, economic structure, data explorer — plus a dedicated **investment-intelligence module**: composite attractiveness score (0–100), risk/return matrix, and a red-flag detector.

🔗 [Live Demo](https://world-bi-dashboard.streamlit.app/) · [Repository](https://github.com/maxin-dac/world-economic-dashboard)

<!-- Optional screenshot — uncomment and adjust the path once your image is in the repo:
![Dashboard preview](https://raw.githubusercontent.com/maxin-dac/world-economic-dashboard/main/image-1.png)
-->

<div align="right">

📂 More on my [repositories](https://github.com/maxin-dac?tab=repositories) and [Kaggle](https://www.kaggle.com/maximendacleu/)
...
![Cursor](https://img.shields.io/badge/Cursor-000000?style=flat&logo=cursor&logoColor=10b981)
...
![Power Query](https://img.shields.io/badge/Power_Query-008272?style=flat&logo=microsoft&logoColor=white)
![Power Pivot](https://img.shields.io/badge/Power_Pivot-107C41?style=flat&logo=microsoft&logoColor=white)
...
![Microsoft Fabric](https://img.shields.io/badge/Microsoft_Fabric-1F4E5B?style=flat&logo=microsoft&logoColor=white)
...
![Azure Data Fundamentals](https://img.shields.io/badge/DP--900-Azure_Data_Fundamentals-0089D6?style=flat&logo=microsoftazure&logoColor=white)
...
<details>
<summary><strong>See my other Applied Skills</strong></summary>
<br>
...
- Implement information protection and data loss prevention using Microsoft Purview
